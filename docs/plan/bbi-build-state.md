...
| 9 | PB-9 | Extend `bbi_landing` gate to detect collection templates | ✅ | commit `TBD` `theme/layout/theme.liquid` | **Done.** Added `template == 'collection.category'` to bbi_landing gate. Smoke test deferred to PB-10 (first collection.category page exercises it). |
