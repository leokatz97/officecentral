...
### LEGAL-HARDENING PASS (2026-06-04) — System C pages 22/23/24, same branch, DOCS ONLY (REDUCES risk, does NOT clear the gate)
Applied to all three (per legal-hardening brief): (1) **Airtight sourcing** — every L-flag re-traced to the competitor's OWN current public source with exact URL + "verified 2026-06-04"; POI claims not re-confirmable on poi.ca today were CUT/softened ("over 65 years", "Flooring/Construction Solutions" Google-KG phrasing → poi.ca/services-verified service list; specific city list dropped; "largest and longest-running" superlative removed). atWork + Office Shop fully re-confirmed live, no cuts. (2) **Non-affiliation/nominative-use disclaimer** — one clean sentence per page after the comparison table. (3) **Superiority scrub** — reframed implied put-downs + comparatives to buyer-FIT (POI: "structural advantage", "respect your time/opposite of", "leaner"; atWork: "worth more", "almost always the better deal", FAQ "hits a budget better" → synced; Office Shop: "respects the buyer's time/opposite of", "salesperson's word"). Retained fit-scoped "better fit" + explicit non-superiority disclaimers. (4) **CIPO check** — Canadian Trademarks DB is a JS interface, no automated results; recorded "CIPO check pending — for lawyer to confirm" per page (atWork ToU notes its marks "registered or not"; "the office shop" flagged as descriptive). (5) **Title options** — two framings per page in each .md (current max-SEO "Best Alternative to / Alternative" vs editorial "[X] vs Brant Business Interiors: an Ontario buyer's comparison"); lawyer picks. Re-run gates all PASS: POI 2,327w (52/148), atWork 2,282w (45/140), Office Shop 2,248w (37/155); byte-match + 6/6 links 200 each; no em-dashes. **Still legal-gated — lawyer + Steve before any publish; POI first, then watch.**

---

## BATCH 2 — SYSTEM C ADD (2026-06-04) — 2 more alternative pages, same branch, DOCS ONLY, LEGAL-GATED + HIGHER-ENFORCEMENT-RISK (Staples, Grand & Toy)
Built legal-hardened from draft v1 (5 measures inline). **Both flagged PROMINENTLY for the lawyer as higher-enforcement-risk targets:** Staples and Grand & Toy are large national companies with well-known marks carrying real goodwill + active legal teams, so comparative trademark use (s. 22) carries materially higher C&D risk than naming a small dealer. Strictly nominative, factual model description, zero disparagement; hardening measures 4 (CIPO) + 5 (title options) matter MOST. **KEY LEARNING APPLIED (avoids the #108 rework):** verified each competitor's ACTUAL public model + credentials from its OWN source before framing — and found BOTH hold OECM furniture agreements (co-listed with Brant Basics/Office Central) AND offer design/install (Staples Workplace Studio; G&T Workspace Interiors). So OECM + design/install (and for G&T, brand access too) are framed as SHARED, never as gaps — the contrast is purely model-FIT (furniture-specialist dealer vs national retail catalogue / broad supplies distributor). No consumer-only / light-commercial-only / cheaper / quality framing.

### B2 System C Page 4 — Best Alternative to Staples Office Furniture (Ontario) ✅ COMMITTED
- **Primary kw:** `staples office furniture` (260/mo, KD1, navigational, CPC $3.69) — target the "alternative" modifier, not the bare brand. **Cluster:** staples furniture (210, KD6, transactional); staples business furniture (10); office furniture staples canada (10, KD32). **Referenced not targeted:** bare "staples" brand-nav.
- **Competitor public model (verified 2026-06-04):** national self-serve retail + online catalogue (consumer-to-light-commercial, house lines Union & Scale + Offices to Go) PLUS Staples Professional business arm (Workplace Studio design/install) + OECM partner since 2009. SOURCING NOTE: staples.ca/staplesprofessional.ca 403 on direct fetch → snippet-sourced rows L-1/L-2 marked RE-VERIFY at publish; OECM rows directly fetched from oecm.ca (solid); US staples.com furniture-services page labelled [US], model-context only.
- **Honest contrast (FIT):** furniture-specialist dealer (plans/installs/services) vs national retail catalogue + business program. OECM + design/install = SHARED (honesty pivot). 3-column model table (retail / Staples Professional / dealer). Fairness section "When Staples is the right pick" (single items, home office, ad-hoc, supplies consolidation, national consistency).
- **Products (verified, distinct from POI/atWork/Office Shop):** Global Robust 500lb multi-tilter (GLB74475), Offices to Go Newland 4-person workstation, Global multi-storage cabinet 93365MSL (prose). No product Made-in-Canada/warranty-years.
- **Legal:** F LEGAL FLAG table (4 named-Staples rows, each sourced + dated, 2 flagged RE-VERIFY) · non-affiliation disclaimer · CIPO pending (JS interface) · superiority scrub log · 2 title options (recommend lawyer weigh editorial (b) given enforcement profile). HIGHER-RISK flagged.
- **Links (verified 200):** /products/robust-...-glb74475, /products/4-person-workstation, /collections/buy-canadian, /pages/design-services, /pages/oecm, /pages/quote.
- **Length:** 2,214 words (≥2,200 floor PASS). **Gates:** validate-meta 54/153 PASS · check-handles 6/6 200 · create-draft DRY RUN byte-match 6/6 PASS · 0 em-dashes.

### B2 System C Page 5 — Best Alternative to Grand & Toy Office Furniture (Ontario) ✅ COMMITTED
- **Primary kw:** `grand and toy office furniture` (20/mo, KD39, navigational) — "alternative" modifier. **Cluster:** grand and toy furniture (20, KD39). **VOLUME CAVEAT:** low traffic, aggregate/long-tail play; bare `grand and toy` (49,500/mo) is generic supplies, NOT targeted.
- **Competitor public model (verified 2026-06-04, directly fetched grandandtoy.com):** B2B business-products distributor (ODP Group subsidiary, since 1882, Vaughan HQ) — supplies/tech/furniture/breakroom/print; furniture via Workspace Interiors division (specification/PM/install); range "value-priced commercial through grade-A designer/custom"; lists Global, ergoCentric, Keilhauer, etc.; holds OECM furniture agreement (2031, co-listed with Brant Basics).
- **Honest contrast (FIT) — TRIPLE honesty pivot:** OECM + design/install + BRAND ACCESS all SHARED (overlapping Global/ergoCentric named honestly). Only axis = furniture-specialist dealer (furniture is the whole business) vs broad business-products distributor with a furniture division. 2-column model table. Fairness section "When Grand and Toy is the right pick" (vendor consolidation, furniture as small part of larger spend, national multi-site). Body uses "Grand and Toy" spelled out; title uses the "Grand & Toy" mark.
- **Products (verified, distinct):** ergoCentric Part-Time armless task chair (MVL2836 — deliberately chosen: on G&T's OWN roster, makes the overlap point), Global Concorde 24HR exec synchro-tilter (2424), Global flip-top tables + Zira storage credenza (prose). No product Made-in-Canada/warranty-years.
- **Legal:** F LEGAL FLAG table (5 named-G&T rows, sourced + dated; L-2 install/PM partly 2016-press-release → re-verify) · non-affiliation disclaimer · CIPO PARTIAL (GO BIZZY BY GRAND & TOY = REGISTERED TMA1357554, registered 2025-11-07; plain "GRAND & TOY" word-mark NOT confirmed via reachable records → lawyer manual search) · superiority scrub log · 2 title options (recommend lawyer weigh editorial (b)). HIGHER-RISK flagged.
