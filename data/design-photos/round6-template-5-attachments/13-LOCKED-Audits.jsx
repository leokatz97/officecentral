...
// Round 5: appends "landing" alongside the locked homepage / cc / cn slices.
...
register("collection", {
  ...
  links: [
    ...
    { cells: ["24 product titles", "/products/{slug}", "Down to template 5 (PDP, future)"], status: "stub" },
    ...
    { cells: ["12 brand plates", "/pages/brands/{slug}", "Sideways to template 4 (future)"], status: "stub" },
    { cells: ["OECM tertiary CTA", "/pages/oecm", "Sideways"], status: "pass" },
    { cells: ["Closer · Request a quote", "/pages/quote", "RFQ"], status: "pass" },
    { cells: ["Closer · phone link", "tel:1-800-835-9565", "Phone fallback"], status: "pass" },
    { cells: ["Footer Shop / Industries / Services / Contact / Legal", "Real routes", "Down + sideways"], status: "pass" },
...
/* ---------- template 4: landing · OECM (round 5, NEW) ---------- */
register("landing", {
