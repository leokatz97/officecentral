...
function ContrastAudit() {
  const rows = [
    ...
    { label: "Header request-quote (charcoal default)", fg: "#FFFFFF", bg: "#0B0B0C", ratio: "20.10:1", level: "AAA", role: "button 14px/600" },
...
function TokenCoverageAudit() {
  ...
  const reserved = ["--newBadgeBackground", "--preorderBadgeBackground", "--soldBadgeBackground", "--customBadgeBackground", "--cartCountBg", "--cartCountColor", "--submenuBg", "--submenuColor", "--submenuHoverColor", "--ratingStarColor", "--sliderArrowBackground", "--sliderArrowColor", "--productIconColor", "--productIconBg", "--shadowColor"];
  return (
    <div className="audit-card">
      <div className="audit-card__head">
