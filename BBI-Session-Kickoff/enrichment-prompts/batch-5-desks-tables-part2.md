# PE Pass 2 — Batch 5: Desks & Tables — Part 2 of 2
# 10 products · paste this as your FIRST message in a new session
...
BATCH: Batch 5 — Desks & Tables — Part 2 of 2 (10 products)
...
BATCH HANDLES (10 products, work through in this order):
   1. folding-table-30-x-96-1
   2. folding-table-30x-72
   3. height-adjustable-base-pneumatic
   4. management-u-shaped-suite-with-3-stage-height-adjustable-table
   5. quick-assembly-electric-height-adjustable-base
   6. quick-assembly-height-adjustable-base
   7. round-table-glass-top
   8. table-29-x-28-4
   9. table-29-x-28-5
  10. tables-dolly-7
...
## Products in this batch (10 total)

| Handle | Code | Tier | Price |
|---|---|---|---|
| folding-table-30-x-96-1                       |                | C    | $  195.38 |
| folding-table-30x-72                          |                | C    | $  164.67 |
| height-adjustable-base-pneumatic              |                | C    | $  699.99 |
| management-u-shaped-suite-with-3-stage-height |                | C    | $ 2775.00 |
| quick-assembly-electric-height-adjustable-bas |                | C    | $  999.99 |
| quick-assembly-height-adjustable-base         |                | C    | $  944.49 |
| round-table-glass-top                         |                | C    | $  420.00 |
| table-29-x-28-4                               |                | C    | $  350.19 |
| table-29-x-28-5                               |                | C    | $  350.19 |
| tables-dolly-7                                |                | C    | $  536.55 |
...
**Next batch after this one: Batch 6**
