...
> ✅ Hero spec session H1B complete. Merged and pushed to Shopify.
> **Next session → open `BBI-Session-Kickoff/hero-spec-prompts/hero-batch-H2.md` in a new Claude session.**
