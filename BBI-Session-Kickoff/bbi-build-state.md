...
4. **LANDING-PAGE-THEME-CONTENT-REFRESH (theme write):** align H1/hero/FAQ body copy with locked primary KWs on the 3 landing pages — gated by Steve approval + the write-phase preflight (verify `186373570873` role=main, kill any `shopify theme dev` watcher, Admin-API readback on every PUT).
