...
2. **Blog #2 — P1 design/space-planning cornerstone** (Leo) — lead production focus per the locked roadmap; proven model from Post 1. **🆕 First draft READY** (`data/content-drafts/01-office-space-planning-pillar.md`, batch-1 overnight 2026-06-03) — Leo edits to voice + fact-checks ⚠️ flags, then ships.
