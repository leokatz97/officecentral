...
| PE-PASS-3 | Push enrichment to Shopify (descriptions + specs + vendor) | 🟡 | `scripts/push-pe3-enrichment.py` · `data/logs/pe3-push-20260511-234901.json` | **Partial — 66/157 enrichment products pushed (2026-05-11).** Script: reads `pe-pass2-output.json`, writes `body_html` + 12 `specs.*` metafields + vendor. Completed batches pushed: 1 (25), 2 (26), 5 (10), partial 7 (7) = 66 products. Remaining 89 products need enrichment sessions (batches 3 Chairs Pt3/0/25, 4 Desks Pt1/0/27, 6 Storage/0/30, 1 remaining Batch 1, 6 remaining Batch 7). **After each new enrichment session, re-run:** `python3 scripts/push-pe3-enrichment.py --live` |
