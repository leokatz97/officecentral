#!/usr/bin/env python3
"""
PE-7 push: write meta_title + meta_description from
data/reports/pe7-longtail-seo.csv into Shopify product SEO fields.
...
Safety:
  ...
  - Logs every mutation outcome to data/logs/pe7-push-<ts>.json.
...
CSV_PATH = ROOT / 'data/reports/pe7-longtail-seo.csv'
...
def main():
    ...
    backup_path = BACKUP_DIR / f'pe7-seo-pre-push-{ts}.csv'
    ...
    log_path = LOG_DIR / f'pe7-push-{ts}.json'
